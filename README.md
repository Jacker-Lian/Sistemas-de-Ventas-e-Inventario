...
![GET](https://github.com/Jacker-Lian/Sistemas-de-Ventas-e-Inventario/blob/feature/gestion-gastos/img/leer.png?raw=true)    

Este método obtiene la lista completa de gastos registrados en la base de datos.

![GET?](https://github.com/Jacker-Lian/Sistemas-de-Ventas-e-Inventario/blob/feature/gestion-gastos/img/parametros.png?raw=true)    
...
![POST](https://github.com/Jacker-Lian/Sistemas-de-Ventas-e-Inventario/blob/feature/gestion-gastos/img/crear.png?raw=true)
...
![GETBYID](https://github.com/Jacker-Lian/Sistemas-de-Ventas-e-Inventario/blob/feature/gestion-gastos/img/leerporid.png?raw=true)
...
![PUTBYID](https://github.com/Jacker-Lian/Sistemas-de-Ventas-e-Inventario/blob/feature/gestion-gastos/img/editarporid.png?raw=true)

Metodo para editar un gasto, en el cual se envían los nuevos datos del gasto en el body de la petición.

### ELIMINAR POR ID

![PATCHBYID](https://github.com/Jacker-Lian/Sistemas-de-Ventas-e-Inventario/blob/feature/gestion-gastos/img/eliminarporid.png?raw=true)
